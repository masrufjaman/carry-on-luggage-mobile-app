...
public class RequestListActivity extends AppCompatActivity {
    ...
    List<FollerModelAndList> getList;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseFirestore = FirebaseFirestore.getInstance();
        documentReference =  firebaseFirestore.collection("FirendsList")
                .document("Requesteds")
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RequestListActivity.this));
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                for (DocumentChange ds : queryDocumentSnapshots.getDocumentChanges()) {
                 ...
                 Toast.makeText(MainActivity2.this, "" + first, Toast.LENGTH_SHORT).show();*/
                        FollerModelAndList get = ds.getDocument().toObject(FollerModelAndList.class);
                        getList.add(get);
