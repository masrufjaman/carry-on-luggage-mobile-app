...
public class BlogRecyclerAdapter__11 extends RecyclerView.Adapter<BlogRecyclerAdapter__11.BlogViewHolder>
    ...
    public BlogRecyclerAdapter__11(Context context, List<BlogPost> blog_list, RequestManager glide){
    ...
    public void onBindViewHolder(@NonNull final BlogViewHolder holder, final int position) {
        holder.single_linear_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                builder.setTitle("Confirmation")
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        final KProgressHUD progressDialog=  KProgressHUD.create(holder.itemView.getContext())
                        ...
                        firebaseFirestore.collection("Posts")
                                .document(blogListFiltered.get(position).getImage_name())
                                .delete()
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toasty.success(holder.itemView.getContext(),"Done",Toasty.LENGTH_SHORT,true).show();
                                            return;
                                        }
                                    }
                                });
        ...
        firebaseFirestore.collection("User2").document(user_id)
                                ...
                                firebaseFirestore.collection("My_Post_Indi")
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    progressDialog.dismiss();
                                                    Toasty.success(context,"Done",Toasty.LENGTH_SHORT,true).show();
                                                    return;
                                                }
                                            }
                                        });
